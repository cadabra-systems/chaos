...
namespace chaos { namespace redis {
	...
	inline reply_ptr make_reply(redisContext* context, int argc, const char** argv, const std::size_t* argvlen) noexcept
	{
		return !context ? reply_ptr{nullptr, freeReplyObject} : reply_ptr{static_cast<redisReply*>(redisCommandArgv(context, argc, argv, argvlen)), freeReplyObject};
	}
} }
